...
public class DatabaseHandler {
    ...
    public static final String COORDINATES_TABLE = "coordinate";
    ...
    public static final String CHAPTER_TABLE_MARINES_PARENT_LEGION = "marines_count";
    ...
    private void connectToDatabase() {
        try {
            ...
            Logger.getLogger("Database connection established.");
        } catch (ClassNotFoundException e) {
            Outputer.printerror("The database management driver was not found!");
            Logger.getLogger("The database management driver was not found!");
        } catch (SQLException throwables) {
            Outputer.printerror("An error occurred while connecting to the database!");
            Logger.getLogger("An error occurred while connecting to the database!");
        }
    }
    /**
    ...
    public PreparedStatement getPreparedStatement(String sqlStatement, boolean generateKeys) throws SQLException {
        ...
        try{
            ...
            if (connection == null) Logger.getLogger("Database connection not established!");
    ...
    public void setSavepoint() {
        try {
            ...
            Logger.getLogger("An error occurred while saving the database state!");
        }
    }
}
